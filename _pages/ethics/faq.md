...
As announced in the AACL-IJCNLP 2026 call for papers:
...
This page provides an FAQ about the ethics review process and guidance to authors for how to address ethical considerations in your AACL-IJCNLP 2026 papers. This applies in the first instance to papers submitted to the main conference (including industry track papers and demo papers). We encourage AACL-IJCNLP 2026 workshops to follow similar principles.


## How is AACL-IJCNLP 2026 handling ethics review?
...
*   Reviewers are asked to consider the points listed in the [ethics review questions page](/ethics/review-questions/) and then indicate whether a paper should be flagged for further ethics review and, if so, what considerations lead them to that recommendation.

*   A reviewing committee, dedicated to ethical issues, will review papers flagged as problematic by the reviewers or the ACs during the review process.
...
## Can papers be rejected from AACL-IJCNLP 2026 due to ethical concerns?
